...
public class ViewSpringConfig {
    ...
    public ExpertView expertView(ExpertService expertService, ServiceService serviceService,
                                 SuggestionService suggestionService, OrderService orderService, Validation validation) {
        ...
        expertView.setOrderService(orderService);
        expertView.setValidation(validation);
        return expertView;
    }
